...
public class costcoCartTestCase {
	...
	public static String continueShopping="(//button[@class='btn btn-tertiary btn-block'])[1]";
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Cart is Updated and now has: "+driver.findElement(By.xpath(cartItemAmount_XPATH)).getText()+" items in the cart.");

		//Click on cart is intercepting with continue shopping element and thus this script will do separately
		WebElement element = driver.findElement(By.xpath(continueShopping));
		js.executeScript("arguments[0].click();", element);
		element = driver.findElement(By.xpath(Cart_XPATH));
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath(cartTotal))));
...
//		js.executeScript("arguments[0].click();",remove);
		...
		System.out.println("Item 2 in the cart is removed from the cart and Cart Total is updated to: $"+CartTotal2$);


		if(CartTotal2$>0 && CartTotal2$>=CartTotal$) {
